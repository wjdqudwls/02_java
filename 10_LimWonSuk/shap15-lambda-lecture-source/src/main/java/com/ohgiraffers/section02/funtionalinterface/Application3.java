...
public class Application3 {
    public static void main(String[] args) {
         ...
         * Function
         * - 매개병수를 받아서 다른 타입으로 변환하여 반환하는 함수형 인터페이스
         * - 매개 변수와 반환형을 모두 가지고 있는 applyXXX() 메소드룰 가지고 있다 */





        /* 1. Function<T, R>#apply(T t) : R : 객체 T(Tyoe)를 R(Return)로 매핑한다. */
