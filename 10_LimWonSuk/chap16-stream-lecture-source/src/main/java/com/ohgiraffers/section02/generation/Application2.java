...
public class Application2 {
    public static void main(String[] args) {
        ...
        IntStream intStream = IntStream.range(5, 11); // 5 이상 11미만의 정수 스트림 생성
        intStream.forEach(i -> System.out.println(i + " ") );
        System.out.println();

        LongStream longStream = LongStream.rangeClosed(5, 11); // 5 이상 11미만의 정수 스트림 생성
        ...
        System.out.println();
        // double 들을 래퍼클래스인 Double로 boxed 해서 바꿔주는것
