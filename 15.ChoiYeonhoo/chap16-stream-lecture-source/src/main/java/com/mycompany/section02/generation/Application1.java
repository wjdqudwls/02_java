...
//    strStream.forEach(str-> System.out.println(str) );
    ...
    Stream<String> strStream3 = Stream.<String>builder() // 원본 없이 1회용 스트림 생성
        .add("java")
        .add("mariadb")
        .add("spring")
        .add("vue3")
    ...
    // 스트림은 1회용임을 확인
    strStream3.forEach(str-> System.out.println(str.toUpperCase())); // 에러 발생, stream has already been operated upon or closed
