package com.mycompany.section05.array.level02.normal;
...
public class Application1 {
  ...
  public static void main(String[] args) {
    ...
    for (char c : cArr) {
      if (c == searchChar.charAt(0)) {
        count++;
      }
    }
    System.out.println("입력하신 문자열 " + inputStr + "에서 찾으시는 문자 " + searchChar + "은/는 " + count + "개 입니다.");
  }
