package com.kth.section01.conditional.level04.advanced;
...
public class Application2 {
  ...
  public static void main(String[] args) {
    ...
    if (saleAmount >= 50000000L) {
      bonusRate = 0.05;
    } else if (saleAmount >= 30000000L) {
      bonusRate = 0.03;
    } else if (saleAmount >= 10000000L) {
      bonusRate = 0.01;
    } else {
      bonusRate = 0.00;
    }

    bonusAmount = Math.round(saleAmount * bonusRate);
    long totalSalary = monthSalary + bonusAmount;
